...
const WS_BASE = `${process.env.NEXR_PUBLIC_COINGECKO_WEBSOCKET_URL}?x_cg_api_key=${process.env.NEXT_PUBLIC_COINGECKO_API_KEY}`;
...
export const useCoinGeckoWebSocket = ({ 
    ...
    useEffect(() => {
        ...
        queueMicrotask(() => {
            ...
            subscribe('CGSimplePrice', {coin_id: [coinId], action: 'set-tokens' });
        })
